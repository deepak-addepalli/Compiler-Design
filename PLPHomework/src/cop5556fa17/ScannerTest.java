...
public class ScannerTest {
	...
	public void testSeparators() throws LexicalException
	{
		...
		checkNext(scanner, RSQUARE, 5, 1, 2, 3);
		checkNextIsEOF(scanner);
	}
